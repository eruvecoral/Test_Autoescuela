...
public class Activity_GridLayout_graficos_secciones extends AppCompatActivity {

    private List<String> elementos;
    private Bundle datos;
    private TextView miUsuario, miSeccion;
    private Button btn_irTemas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.elemento_secciones_grafico);
        ...
        btn_irTemas = (Button) findViewById(R.id.btn_irTemas);
        obtenerPuntuacionPorSeccion("http://192.168.56.1/autoescuela_rabel/obtenerPuntuacionPorSeccion.php", stringTablaRespuestas, countSeccion);

        btn_irTemas.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void obtenerPuntuacionPorSeccion(String responseBody, String stringTabla, String seccion) {
...
//                    createIntent();
                    ...
                    Toast.makeText(Activity_GridLayout_graficos_secciones.this, e.toString(), Toast.LENGTH_SHORT).show();
                    Toast.makeText(Activity_GridLayout_graficos_secciones.this, "Error de conexion", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Activity_GridLayout_graficos_secciones.this, error.toString(), Toast.LENGTH_SHORT).show();
                Toast.makeText(Activity_GridLayout_graficos_secciones.this, "Error response", Toast.LENGTH_SHORT).show();
