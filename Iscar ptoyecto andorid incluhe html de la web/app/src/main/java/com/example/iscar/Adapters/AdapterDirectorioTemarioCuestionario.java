 ...
 */
public class AdapterDirectorioTemarioCuestionario extends RecyclerView.Adapter<AdapterDirectorioTemarioCuestionario.ViewHolder> {
    ...
    public AdapterDirectorioTemarioCuestionario(List<RecyclerTemario> lista,
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = inf.inflate(R.layout.elemento_tema_cuestionario,null);
