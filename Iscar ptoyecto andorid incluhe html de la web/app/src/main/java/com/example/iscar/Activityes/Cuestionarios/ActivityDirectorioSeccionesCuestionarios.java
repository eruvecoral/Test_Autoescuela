...
import com.example.iscar.Adapters.AdapterDirectorioSeccionesCuestionario;
...
public class ActivityDirectorioSeccionesCuestionarios extends AppCompatActivity {
    ...
    public void init()
    {
        ...
        AdapterDirectorioSeccionesCuestionario elementAdapter = new AdapterDirectorioSeccionesCuestionario(elementos,this, new AdapterDirectorioSeccionesCuestionario.OnItemClickListener(){
    ...
    {
        Intent i = new Intent(this, ActivityTemarioTemas_Cuestionario.class);
