 ...
 */
public class AdapterTemasCarpetasGraficas extends RecyclerView.Adapter<AdapterTemasCarpetasGraficas.ViewHolder> {
    ...
    public AdapterTemasCarpetasGraficas(List<String> lista,
