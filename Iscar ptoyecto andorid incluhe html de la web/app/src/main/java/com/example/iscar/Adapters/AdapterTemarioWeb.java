 ...
 */
public class AdapterTemarioWeb extends RecyclerView.Adapter<AdapterTemarioWeb.ViewHolder> {
    ...
    public AdapterTemarioWeb(List<RecyclerTemario> lista,
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = inf.inflate(R.layout.activity_temario_web,null);
...
//            seccion = v.findViewById(R.id.txt_seccion);
//            estado = v.findViewById(R.id.estado_tema);
        }
