 ...
 */
public class AdapterDirectorioSeccionesCuestionario extends RecyclerView.Adapter<AdapterDirectorioSeccionesCuestionario.ViewHolder> {
    ...
    public AdapterDirectorioSeccionesCuestionario(List<RecyclerElemento> lista,
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = inf.inflate(R.layout.elemento_seccion_cuestionario,null);
