 ...
 */
public class AdapterCarpetasTemasGraficas extends RecyclerView.Adapter<AdapterCarpetasTemasGraficas.ViewHolder> {
    ...
    public AdapterCarpetasTemasGraficas(List<RecyclerTemario> lista,
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = inf.inflate(R.layout.elemento_temas_carpetas_graficos,null);
